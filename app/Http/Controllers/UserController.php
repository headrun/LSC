...
class UserController extends Controller
{
    ...
    public function updateOneSignalUser(Request $request){
        if(Auth::check() && (Session::get('userType')=='USER')){

            $inputs = $request->all();

            if(!(User::where('emp_code','=',Session::get('emp_code'))
                     ->where('onesignal_id','=',$inputs['onesignal_id'])
                 ...
                 $user->onesignal_id=$inputs['onesignal_id'];
                 $user->save();
