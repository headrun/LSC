...
<html lang="en">
   ...
   <body>
      ...
      <div class="activity">
         <div class="container">
	    <h1><span class="newactivity">Activity:</span><a style="float:right;" href="/ActivitiesPage" class="back_right">
 Next Page <i class="fa fa-angle-right" aria-hidden="true"></i></a><a style="float:right;margin-right:10px;" href="/Activity2" class="restart">Restart</a><a style="float:right;" href="/Activity1" class="back_right"><i class="fa fa-angle-left" aria-hidden="true"></i>
 Back</a></h1>
         </div>
      </div>
