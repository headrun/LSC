...
<body style="background-color: #79478f;">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
    <div class="container" >
      <div>
        <h1>Hi {{ Session::get('user_name') }}, Welcome to Distribution Activities Module</h1>
      </div>
      <br><br>
      <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
          <div class="card" id ="module2" style="display: none;">
            <div class="row">
              <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
      ...
      <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
          <div class="card" id ="module3" style="display: none;">
            <div class="row">
              <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
