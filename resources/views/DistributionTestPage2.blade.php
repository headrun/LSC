...
<body>
    <div class="container">
        <div class="card">
                <span style="font-size: 28px;line-height: 28px;color: #7d929d;">Factors Affecting Distribution</span>
                <hr>
...
<script>
    ...
    function Decrement() {
        if (document.getElementById) {
            ...
            if (mins < 0) {
                window.location = "{{url()}}/submitQuiz/?subject=Distribution&module=Distribution2";
                alert('time up');
                minutes.value = 0;
                seconds.value = 0;
            }
...
<script>
 ...
 var nextHide;
   var AllQuestions = {
           data: [
           {
               name:'True or False: Perishable items require longer chain of distribution.',
               A: 'TRUE',
               B: 'FALSE',
           ...
           {
               name:"Which of the following is a market related factor affecting distribution channel?",
               A: 'Unit Value of product',
               B: 'Buying habits',
               C: 'Financial strength of firm',
               D: 'Government regulations'
           },
           {
               name:"A spare parts seller stores bolts in packs of 500. Customers buy in smaller quantities, typically 2-3. Why are middle men required?",
               A: 'Companies as a policy do not sell smaller quantities',
               B: 'Manufacturers might not have the ability to break packs and transport smaller quantities directly to end customers',
               C: 'Size of buying does not have any relationship with middle men requirement',
               D: 'No middle men required'
           },
           {
               name:"Retailers get a lower discount from firms than wholesalers. Why do you think it happens?",
               A: 'Wholesalers pay in advance and buy larger quantities, helping firms achieve sale targets',
               B: 'Retailers get same margin as wholesalers',
               C: 'Wholesalers offer marketing services',
               D: 'None of the above'
           },
           {
               name:"Customer buys a bat at 2,000 Rs. Retailer makes 200 Rs profit on this. Wholesaler who sells to retailer makes a 300 Rs profit. Manufacturer who sold it to retailer made a 500 Rs profit. What is the total margin on the product (Margin % = (Selling Price - cost Price)/ Selling Price)?",
               A: '10%',
               B: '25%',
               C: '50%',
               D: '100%'
