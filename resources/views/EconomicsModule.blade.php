                ...
                <div class="card" id ="module4">
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                ...
                                <img src="https://image.flaticon.com/icons/svg/1083/1083518.svg" alt="Smiley face" width="110" height="110">
                            
                        </div>
                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
                            <h3>Planning</h3>
                            <br>
                            <p>The action of making the best use of a resource. It is the process of thinking about the activities required to achieve a desired goal.</p>
                        </div>
                    </div>
                </div>        
            </div>
