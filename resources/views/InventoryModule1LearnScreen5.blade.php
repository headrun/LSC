...
<div class="container-fluid">
   ...
   <div class="row" >
    <div style="padding: 20px;">
      ...
      <br>
      <br>
     <h2><b>(a)</b>In business, source could be far away. For example; Other state or even country.  Lead time (time from ordering to receipt) could be very high. <span style="color: red;">(Immediate demand cannot be satisfied)</span></h2>
     <br>

     <h2><b>(b)</b><i>Cost of regular ordering is very high</i></h2>
     <br><br>
...
if (event.keyCode === 40) {
   ...
   next = next+1;
   if(next == 1){
   window.location = "{{url()}}/InventoryModule1LearnScreen6";
   }
  }
