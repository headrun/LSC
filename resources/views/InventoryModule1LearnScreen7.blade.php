...
<div class="container-fluid">
   ...
   <div class="row" >
    <div style="padding: 20px;">
      ...
      <br>
      <br>
     <h2>You just lost your sale! Sales loss is the biggest nightmare for any business</h2>
     <br>

     <h2><i>Inventory or stock is primarily to ensure sale always happens and stock out is avoided</i></h2>
     <br><br>
