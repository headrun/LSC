      ...
      <button class="submit1" Onclick="Activity();">Submit</button>
        ...
        <script type="text/javascript">
          $(document).on('click', '#next', function(){
            window.location = "{{url()}}/InventoryModule2Act4";
          });
          $(document).on('click', '#back', function(){
            window.location = "{{url()}}/InventoryModule2Act2";
          });
    </script>
        ...
        <script>
            ...
            function Activity() {
                ...
                if (all == suc) {
                   swal({                    title: "Congratulations",                    icon: "success",                    button: "Go to Next Level",                }).then((value) => {                    location.href = '{{url()}}/InventoryModule2Act4';                });
                }
                /*
