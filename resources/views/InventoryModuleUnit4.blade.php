...
<script type="text/javascript">
  $(document).on('click', '#inventoryModule1', function(){
    window.location = "{{url()}}/inventoryModule1";
  });
  $(document).on('click', '#inventoryModule2', function(){
    window.location = "{{url()}}/inventoryModule2";
  });
  $(document).on('click', '#inventoryModule3', function(){
    window.location = "{{url()}}/inventoryModule3";
  });
  $(document).on('click', '#inventoryModule4', function(){
    window.location = "{{url()}}/inventoryModule4";
  });
