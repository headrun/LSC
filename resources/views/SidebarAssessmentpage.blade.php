...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
    <div class="container" >
       ...
       <?php if(Session::get('email') == 'testuser@gmail.com' || Session::get('email') == 'vimal@mieone.com' || Session::get('email') == 'bhargavi@headrun.com' || Session::get('email') == 'abi_monish_v' || Session::get('email') == 'tharun_v'){?>
         <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
               <div class="card" id ="activity1" >
                   <div class="row">
