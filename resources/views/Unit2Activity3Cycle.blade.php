   ...
   <body class="newbg2">
     ...
     <div class="content-section">
      ...
      <div class="game-content">
        ...
        <h2 style="text-align:left;color:#f5b120;">You Have Selected: Cycle </h2>

        <div class="drag-left">
        <div class="plain-section-inner1">
          <img src="Unit2Activity3/images/cycle.gif" alt="Cycle Journey" />
          <div class="plaindetailesinner">
          <span class="time">Speed: 20 km/hr</span>
          <span class="price">Cycle Rent: 400 Rs</span>
          <span class="price">Refreshment cost: 200 Rs</span>
        </div>
