     ...
     <div class="content-section">
      ...
      <div class="content-title">
        ...
        <div class="remainig-data">
          ...
          <div class="remainig-budget" data-step="4" data-intro="Distance::800km">Distance: <span>800 Km</span></div>
        </div>
      ...
      <div class="game-content">
        ...
        <h2 style="text-align:left;color:#f5b120;">You Have Selected: Van</h2>

        <div class="drag-left">
        <div class="plain-section-inner1">
          <img src="Unit2Activity3/images/minivan-surf.gif" alt="Van Journey" />
          <div class="plaindetailesinner">
          <span class="time">Speed: 40 km/hr</span>
          <span class="price">Cost: 3 Rs km/hr</span>
        </div>
      ...
      <div class="backbut"><a href="/Unit2Activity3Level2"><< Back</div>
        <div class="nextbut"><a href="/Unit2Activity3Level3">Goto Next Level >></div>
        </div>
