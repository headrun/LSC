...
<div class="container-fluid">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6">
        <img id="image" class="two" src="{{asset('assets/img/face.png')}}" width ="100%"/ style="z-index: -10">
        <!-- <br><br> -->
        <div class="row three" style="z-index: 100">
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6">
            <img src="{{asset('assets/img/men.png')}}" width="100%" height="200px">
          </div>
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6">
            <br>
            <h2 class="text">Huge investments for construction</h2>
          </div>
        </div>
        ...
        <div class="row three" style="z-index: 100">
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6">
            <br>
            <h2 class="text">Longer time for construction of tracks</h2>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6">
            <img src="{{asset('assets/img/timer.png')}}" width="100%" height="200px">
          </div>
        </div>
        <br>
      </div>
