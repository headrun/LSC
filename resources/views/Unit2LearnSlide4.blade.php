...
<div class="container-fluid">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6">
        <img id="image" class="one" src="{{asset('assets/img/truck.png')}}" width ="100%" style="height: 320px;" />
        <div id="two" style="background-color: white;">
        <br>
          <h3> &#10070; 59 lakh KM of roadways in India</h3>
          <h3> &#10070; 85% of passengers and 65% of freights move through road</h3>
          <br><br>
          <br><br><br>
          <br><br>
        </div>
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6">
        ...
        <div class="row" id="four">
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6">
            <img src="{{asset('assets/img/door.png')}}" width="40%" style="height: 200px;">
          </div>
         <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6">
          <br>
            <h2>Door to Door reach</h2>
          </div>
        </div>
        <br>
        <div class="row" id="four1">
           <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6">
            <br>
            <h2>Extensive across terrains</h2>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6">
            <img src="{{asset('assets/img/mens.png')}}" width="100%" style="height: 200px;">
          </div>
        </div>
        <br>
        <div class="row" id="four2">
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6">
            <img src="{{asset('assets/img/clock.png')}}" width="50%" style="height: 160px;">
          </div>

          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6">
            <br>
            <h2>Faster construction</h2>
          </div>
          <br><br>
        </div>
        <!-- <div>
