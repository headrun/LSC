...
<div class="container-fluid">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6">
        <img id="image" class="three" src="{{asset('assets/img/face.png')}}" width ="100%" />
        <br><br>
        <div class="row" id="four">
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6">
            <img src="{{asset('assets/img/money.png')}}" width="180px;" style="padding: 2px; height: 160px;">
          </div>
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6">
            <br>
            <h2>Taxes are high</h2>
          </div>
        ...
        <div class="row" id="four1">
          ...
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6">
            <img src="{{asset('assets/img/sun.png')}}" width="180px;" style="padding: 2px;height: 160px;">
          </div>
        </div>
        <br>
        <!-- <div>
