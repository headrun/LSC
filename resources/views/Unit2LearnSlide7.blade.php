...
<div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6 img" >
        ...
        <h3>&#10070; World’s third largest domestic and civil aviation market</h3><br><br><br><br><br><br>
        </div>
        
      </div>

      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6">
        <img src="{{asset('assets/img/face.png')}}" id="smiley" width="100%">
        <div class="row center">
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6">
            <img src="{{asset('assets/img/money.png')}}" width="100%" height="100%" id="img1">
          </div>
 <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6" id="h33">
  <br>
            <h2 style="color: black;">Extremely costly</h2>
          </div>
	</div>
<br><br>
        <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6" >
            <br>
            <h2 id="h34" style="color: black;">Weather dependent<br><br>Accident prone</h2>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6">
            <img src="{{asset('assets/img/sun.png')}}" width="67%" height="100%" id="img2">
          </div>
        </div>
      </div>
    </div>
     ...
     <div class="row footer">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6" align="center">
