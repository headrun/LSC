    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6">
        ...
        <div class="row" id = "four" >
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6">
            <img src="{{asset('assets/img/clock.png')}}" style="height: 160px;">
          </div>
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6">
            <br>
            <h2>Long transit times</h2>
          </div>
        </div>
        <br>
        <br>
        ...
        <div class="row" id = "four1">
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6">
            <br>
            <h2>Huge investments to maintain <br><br> Also high amount of handling of material for loading/ unloading/ learance at port</h2>   
          </div>
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6">
            <img src="{{asset('assets/img/money.png')}}" style="height: 160px;">
          </div>
        </div>
      </div>
    </div>
