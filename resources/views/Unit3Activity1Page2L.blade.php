...
<html lang="en">
   ...
   <body class="newbg">
     <div class="activitymap">
         <div class="container">
           <div class="navigate" style="margin-bottom:30px;"><a style="float:right;" href="Unit3Activity1Page3L" class="restart">Go to Next <i class="fa fa-angle-right" aria-hidden="true"></i></a><a style="float:left;" href="/DistributionActivity" class="back_right"><i class="fa fa-angle-left" aria-hidden="true"></i>
   Go to Back</a></div>
         </div>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
              <div class="map-image">
                <img src="Unit3Activity1/images/map.jpg" alt="" />
              </div>
            </div>
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                <div class="stock">
                  ...
                  <h2>  Gobble wants to design their distribution channel for Tamil Nadu.</h2>
                  <h2>They intend to see in 2 main cities – <span>Chennai & Coimbatore</span></h2>

                  <h3>The number of cereal boxes expected to sell in these cities in 1 month is shows</h3>
                  </div>
            </div>
