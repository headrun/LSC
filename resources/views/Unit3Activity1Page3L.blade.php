      ...
      <div class="activity-map">
        ...
        <h4><span>Note: Wholesalers will also sell to retail outlets</span></h4>
          <div class="row">
            ...
            <div class="navigate"><a style="float:right;" href="/Unit3Activity1Page4L" class="restart">Go to Next <i class="fa fa-angle-right" aria-hidden="true"></i></a><a style="float:left;" href="/Unit3Activity1Page2L" class="back_right"><i class="fa fa-angle-left" aria-hidden="true"></i>
 Go to Back</a></div>
