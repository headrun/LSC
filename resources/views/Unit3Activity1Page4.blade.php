   ...
   <body class="newbg">
     <div class="activitymap">
      ...
      <div class="row">
            ...
            <div class="navigate" style="margin-bottom:30px;"><a style="float:right;" href="Unit3Activity1Page5" class="restart">Go to Next <i class="fa fa-angle-right" aria-hidden="true"></i></a><a style="float:left;" href="/Unit3Activity1Page3" class="back_right"><i class="fa fa-angle-left" aria-hidden="true"></i>
 Go to Back</a></div>
