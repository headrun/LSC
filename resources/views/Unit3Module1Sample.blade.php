 ...
 z-index: 11111;
   ...
   <div class="row" style="margin-left: 7%">
     <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" style="color: white;">
       ...
       <h2 style="text-align: -webkit-left;"> <span style = "margin-left:-52px;">Q1.</span><span style="font-family: 'Lora', serif;"> A shoe manufacturer sells 800 units every day through amazon and 1000 units per month through Retail channel. Which is the firm's major distribution channel? </span></h2>
     </div>
   </div>
   ...
   <div class="row">
     <div class="col-md-12 col-sm-12" style="color: white;">
       <div class="quiz-choice correct-q1" style="margin-left: 100px;"><p>E-Commerce</p>
       </div>
       <div class="quiz-choice wrong-q1" style="">
       <p> Supermarket</p>
       </div>
...
<div id="ex1" class="modal">
 ...
 <h3>Amazon is part of E-comerce channel.</h3>
 <h3 style="font-weight: bold;">Step-2</h3>
 <h3>E-Commerce: 800 units per day</h3>
 <h3 style="font-weight: bold;">Step-3</h3>
 <h3>Retail: 1000 units per month = ~ 34 units per day</h3>
 <br>
 <hr>
