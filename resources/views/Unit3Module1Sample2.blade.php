 ...
 z-index: 11111;
   ...
   <div class="row" style="margin-left: 7%">
     <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" style="color: white;">
       ...
       <h2 style="text-align: -webkit-left;"> <span style = "margin-left:-52px;">Q1.</span><span style="font-family: 'Lora', serif;"> Which of the following is a factor deciding distribution channel</span></h2>
     </div>
   </div>
     <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" >
       <img src="{{asset('assets/img/Ec_mod1_demand.jpg')}}" width="230px" height="200px" alt="Image" style="margin-left: 20px;margin-top: 4%; display: none;">
     </div>
 </div>
   <div class="row">
     <div class="col-md-12 col-sm-12" style="color: white;">
       ...
       <p> Consumer market size</p>
       </div>
       <div class="quiz-choice wrong-q1" style="text-align: center;">
       <p> Financial strength of company</p>
       </div>
       <div class="quiz-choice correct-q1" style="margin-right: 20px;text-align: center;">
...
<div id="ex1" class="modal">
 <h1 style="border-bottom: 1px solid grey;">Solution</h1>
  <br>
  <h3>Highly perishability product should ideally have shorter distribution channels to ensure they reach customer without spending too much time middlemen location.</h3>
<br>
  <h3>If the consumer market size is highly fragmented multiple channels of distribution (Retail, Wholesale, Online) would be required to reach the spread customer base.</h3>
 <br>
<h3>Financial strength of company determine if they can invest in retail outlets or have to depend on whole sales or distributors to make their product reach other retails/customer.</h3>
  <br>
 <hr>
