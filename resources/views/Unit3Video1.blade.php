...
<!--       <div class="logo"><a href="index.html"><img src="newcss/images/logo.png" /></a></div>-->
        <div><h3 style = "color:red;"><b>Distribution Channel</b></h3></div>
       ...
       <div class="row">
         ...
         <div class="col-xs-12 col-lg-7 col-md-7 col-sm-7">
           <div class="videoimage">
             <video id="myVideo1" width="100%" controls height="354px" poster="newcss/images/Unit3Thumbnail.png">
...
<div class="watc" align="right" style="bottom: 52px;position: absolute;"><a href="/Unit3Video2">Next Page</a></div>
</div>
</div>
</body>
