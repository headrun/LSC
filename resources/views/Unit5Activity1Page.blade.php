...
<div class="activity_content">
    <div class="container">
        <p class="activity1">Hi!  Welcome to PackFoods Ltd. You are currently in the Primary warehouse of PackFoods.</p>
        <p class="activity2">Let us give you an introduction!</p>
        <div class="getstarted"><a href="/Unit5Activity1Page2">Go to next screen</a></div>
    </div>
</div>
</body>
