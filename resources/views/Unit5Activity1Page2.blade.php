...
<div class="activity_content">
    <div class="container">
        <p class="activity1">Packfoods trades various FMCG products on a day to day basis. </p>
        <p class="activity2">Following are the products</p>
        <div class="non-branded">
            <ul>
                <li><img src="Unit5Activity1/images/biscuits.jpg" /></li>
                <li><img src="Unit5Activity1/images/aata.jpg" /></li>
                <li><img src="Unit5Activity1/images/bread.jpg" /></li>
                <li><img src="Unit5Activity1/images/cooking-masala.jpg" /></li>
                <li><img src="Unit5Activity1/images/readymade-breakfast.jpg" /></li>
            </ul>
        </div>
        <div class="getstarted"><a href="/Unit5Activity1Page3">Go to next screen</a></div>
    </div>
</div>
</body>
