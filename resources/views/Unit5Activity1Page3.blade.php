...
<div class="activity_content">
    <div class="container">
        <div class="main-img">
            <img src="Unit5Activity1/images/cartton-img.png">
        </div>
        <p class="activity1">You are the Warehouse Manager for today! You will be presented with business requirements and few decision factors.  </p>
        <p class="activity2">Make the right decision!</p>
        <div class="getstarted"><a href="/Unit5Activity1Page4">Go to next screen</a></div>
    </div>
</div>
</body>
