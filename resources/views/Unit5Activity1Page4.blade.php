...
<div class="activity_content">
    <div class="container">
        <div class="main-img-1">
            <img src="Unit5Activity1/images/warehouse.png">
        </div>
        <p class="activity1">Today, materials are being received from suppliers into the warehouses. They will be stored and later dispatched basis customer orders</p>
        ...
        <div class="getstarted"><a href="/Unit5Activity1Page5">Go to next screen</a></div>
    </div>
</div>
</body>
