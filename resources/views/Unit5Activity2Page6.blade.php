...
<body class="newbg">
    <div class="activity_content">
        <div class="container">
            <p class="activity1">Now let us assume EmporioApparel performs Batch Picking</p>
            <p class="activity2">Batch picking – Total quantity is picked at product level instead of at SKU level and then segregated for each order.</p>
            <p class="activity2">For example, if Order 1 needs 10 units of Product 1, Order 2 needs 15 units of Product 1 – total of 25 units of Product 1 are picked. These 25 units are then segregated against each order.</p>

            <div class="getstarted"><a href="/Unit5Activity2Page7" class="submit-btn">Go to next screen</a></div>
