...
<body id="body">
  <div class="container-fluid">
    <div class="row">
        <div>
        <h1 id="heading" class="w3-animate-left" style="text-align: center;font-size: 70px;">Industry Characteristics</h1>
        <h2 id = "start" class="w3-animate-left" style="color: red;text-align: center;font-size: 40px;margin-top:30px;">Lets learn it in more detail !!</h2>
          ...
          <h2 id="h2" class="w3-animate-left" style="font-size: 30px;">To understand handling of specific inventories in warehouse, one should be familiar with</h2>
        ...
        <ul>
          <li id="plan" class="w3-animate-left" style="font-size: 30px;"><span style='font-size:30px;color: white;'>&#10148;</span>Certain warehouse processes of warehousing industries</li>
          <li id="move" class="w3-animate-left" style="font-size: 30px;"><span style='font-size:30px;color: white;'>&#10148;</span>Specific inventory management concepts across industries</li>
