...
<div class="container-fluid">
   <div class="row" style="background-color: white;">
     <h2 align="center"><b>Industry requirement of warehousing depends on warehouse characteristics like the below<b> </h2>
   </div>
  <br>
    <div class="row" align="center"> 
      <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
        <img src="{{asset('assets/img/U5M1one.jpg')}}" width="230px;" height="230px;">
        <p>Short Shelf life products</p>
        <br>
        <p id="para">FMCG</p>
        <p id="para">Pharmaceuticals</p>
      </div>
      <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
        <img src="{{asset('assets/img/U5M1two.png')}}" width="230px;" height="230px;">
        <p>Long Shelf life products</p>
        <br>
        <p id="para">Automotive Goods</p>
        <p id="para">Apparel</p>
      </div>
      <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
        <img src="{{asset('assets/img/U5M1three.jpg')}}" width="230px;" height="230px;">
        <p>Bulk Product Handling</p>
        <br>
        <p id="para">Coal</p>
        <p id="para">Cement/ Grains</p>     
      </div>
    </div>
<br>
