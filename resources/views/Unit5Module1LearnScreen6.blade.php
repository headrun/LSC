...
<div class="container-fluid">
   <div class="row" style="background-color: white;">
     <h2 id="one"><b>Activities that an FMCG warehouse has to do :<b> </h2>
   </div>
   <div class="row" >
    <div style="padding: 20px;">
      <!-- <h2 id="two" class="w3-animate-left">However, assume following complications</h2> -->
      <br>
     <h2 id="two" class="w3-animate-left" style="color: red;">Capture critical information – Lot Code, Manufacturing Date, Expiry Date during receipt into Warehouse</h2>
     <br>
