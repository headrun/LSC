...
<div class="container-fluid">
   ...
   <div class="row">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
      ...
      <img align="center" src="{{asset('assets/img/U5M1ten.jpg')}}" width="550px;" height="550px;">
    </div>
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
      <br>
     <p id="text_para" style="color: blue;">Batch: B026</p>
     <br>
     <p id="text_para">Manufacturing Date: 31-10-2017</p>
     <br>
     <p id="text_para" style="color: red;">Shelf Life: 4 months</p>
     <br>
     <p id="text_para" style="color: #120fa973">Expiry Date: Mfg Date + Shelf Life = End of Feb 2018</p>
    </div>
...
if (event.keyCode === 40) {
   ...
   next = next+1;
   if(next == 1){
   window.location = "{{url()}}/Unit5Module1LearnScreen8";
   }
  }
