...
<div class="container-fluid">
   ...
   <div class="row">
    <h2>Consider an Example of FEFO (First Expiry First Out)</h2>
    <h2>The Same cookie biscuit is received yesterday and today in a warehouse. Order was received today</h2>
  </div>
    ...
    <div class="row"> 
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" id="two">
        <p>Order</p>
        <table>    
          <tr>
            <th>Day</th>
  ...
  <br>
  <h2 id="three">As per FEFO, packs with earliest expiry is sent out first. In this case Batch B1</h2>
  <br>
  <div class="row" id="four">  
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
        <br><br><br>
        <p style="color: red;">Since only 50 packs of B1 is available, remaining 60 packs of B2 are sent</p>
...
if (event.keyCode === 40) {
   ...
   window.location = "{{url()}}/Unit5Module1LearnScreen7";
   }
  }
});
