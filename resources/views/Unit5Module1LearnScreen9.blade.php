...
<div class="container-fluid">
   ...
   <div class="row" >
    <div style="padding: 20px;">
      ...
      <br>
     <h2 id="two" class="w3-animate-left"><span>&#10148;</span>First In First Out (FIFO) – Material received first in the warehouse is sent first</h2>
...
if (event.keyCode === 40) {
   ...
   if(next == 1){
    ...
    window.location = "{{url()}}/Unit5Module1LearnScreen10";
   }
  }
