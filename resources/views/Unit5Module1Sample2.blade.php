...
.jquery-modal{z-index: 11111;}
   ...
   <div class="row" style="margin-left: 10%">
     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="color: white;">
       ...
       <h2 style="text-align: -webkit-left;font-style: ">
        <span style = "margin-left:-52px;">Q2.</span>
        <span style="font-family: 'Lora', serif;">Which of the following methods ensure that materials reach consumers before expiry?</span></h2>
     </div>
   </div>
   ...
   <div class="row">
     <div class="col-md-12 col-sm-12" style="color: white;">
       ...
       <p style="margin-top: 20px;"> Last In First Out (LIFO)/ Last Expiry First out (LEFO)</p>
       </div>
       <div class="quiz-choice correct-q1">
       <p style="margin-top: 20px;"> First In First Out (FIFO)/ First Expiry First Out (FEFO)</p>
       </div>
       <div class="quiz-choice wrong-q1">
       <p style="margin-top: 20px;"> Random Assignment</p>
       </div>
       <div class="quiz-choice wrong-q1" style="margin-right: 20px;">
       <p style="margin-top: 20px;"> No methods can guarantee before expiry receipt to customers</p>
       </div>
     </div>
   </div>
   ...
   <div id="ex1" class="modal">
     ...
     <h3 id="step">Step-1</h3>
      <h3>If each locations follows a sequence of first expiry (material approaching expiry date first) being the first to be sent out to next level, this would ensure all material reaches consumers before expiry.Hence last expiry first out ins followed (LEFO).In cases where expiry date is not known to a facility, FIFO (First In First Out) will be followed. This means that the material received first will be sent out first.</h3>
