      ...
      <div class="row" style="margin-left: 3%">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
           <div id="question-one" class="quiz-ans-container" style="padding-bottom: 60px;padding-top: 5px;">
            <h2 style="text-align:-webkit-left;font-family: 'Lora', serif;"><span style="margin-left: -44px;">Q1. </span>A Yogurt box expires on December 1st 2019. The pack mentiones "Best before 3 months from date of manufacture". What is the manufacturing date?</h2> 
           </div>
        </div>
    ...
    $.confirm({
        ...
        buttons: {
            tryAgain: {
                ...
                btnClass: 'btn-green',
                action: function(){
                  window.location = "{{url()}}/Unit5Module1Timer2";  
                }
            },
        }
    });
