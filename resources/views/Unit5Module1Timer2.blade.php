 ...
 <div class="hours">
  ...
  <div class="card">
      ...
      <div class="row" style="margin-left: 3%">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
           <div id="question-one" class="quiz-ans-container" style="padding-bottom: 60px;padding-top: 5px;">
            <h2 style="text-align:-webkit-left;font-family: 'Lora', serif;"><span style="margin-left: -44px;">Q2. </span>Which of the following products expires first?</h2> 
           </div>
        </div>
       ...
       <div class="quiz-choice wrong-q1">
         <p> Biscuits Expiring on 18th April 2020</p>
       </div>
       <div class="quiz-choice wrong-q1">
         <p> Dosa Batter made on 12th march with Use upto 4 days from packing</p>
       </div>
       <div class="quiz-choice correct-q1">
         <p> Atta bought on 15th Jan 2020 with 2 months expiry</p>
       </div>
       <div class="quiz-choice wrong-q1">
         <p> Milk bought on 29th March with same day expiry</p>
       </div>
    ...
    <div id="ex1" class="modal">
      ...
      <h3>Expiry Dates: Biscuit: 18th April 2020</h3>
      <h3 style="font-weight: bold;">Step-2</h3>
      <h3>Dosa Batter - 16th March 2020</h3>
      <h3 style="font-weight: bold;">Step-3</h3>
      <h3>Atta - 15th March 2020</h3>
      <h3 style="font-weight: bold;">Step-4</h3>
      <h3>Milk - 29th March 2020</h3>
      <br>
      <hr>
    ...
    $.confirm({
        ...
        buttons: {
            tryAgain: {
                ...
                btnClass: 'btn-green',
                action: function(){
                  window.location = "{{url()}}/Unit5Module1Timer3";  
                }
            },
        }
    });
  ...
  $('.wrong-q1').click(function(){
    $.confirm({
		...
		text: 'Back to Concept',
                btnClass: 'btn-red',
                action: "{{url()}}/Unit5Module1Concept1",
                action: function(){
