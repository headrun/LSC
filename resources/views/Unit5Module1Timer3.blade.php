 ...
 <div class="hours">
  ...
  <div class="card">
      ...
      <div class="row" style="margin-left: 3%">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
           <div id="question-one" class="quiz-ans-container" style="padding-bottom: 60px;padding-top: 5px;">
            <h2 style="text-align:-webkit-left;font-family: 'Lora', serif;"><span style="margin-left: -44px;">Q3. </span>A warehouse receives Chips packet with 25 days left to expire. If receipt date is 1st April and shelf life of the product is 45 days from date of packing, what is the packing date?</h2> 
           </div>
        </div>
    ...
    <div id="ex1" class="modal">
      ...
      <h3>Total Shelf Life: 45 days</h3>
      <h3 style="font-weight: bold;">Step-2</h3>
      <h3>Date left to Expire: 25 days</h3>
      <h3 style="font-weight: bold;">Step-3</h3>
      <h3>Age of chips at the date of receipt = 45-25 = 20 days</h3>
      <h3 style="font-weight: bold;">Step-4</h3>
      <h3>Date of Packing = Receipt Date - Age of products = 1st April - 20 Days = 11th March</h3>
      <br>
      <hr>
    ...
    $.confirm({
        ...
        buttons: {
            tryAgain: {
                ...
                btnClass: 'btn-green',
                action: function(){
                  window.location = "{{url()}}/Unit5Module1Sample2";  
                }
            },
        }
    });
