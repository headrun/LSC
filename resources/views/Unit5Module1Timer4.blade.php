 ...
 <div class="hours">
  ...
  <div class="card">
      ...
      <div class="row" style="margin-left: 3%">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
           <div id="question-one" class="quiz-ans-container" style="padding-bottom: 60px;padding-top: 5px;">
            <h2 style="text-align:-webkit-left;font-family: 'Lora', serif;"><span style="margin-left: -44px;">Q1. </span>Three batches of Cooking masala are received by a FMCG major.<br> Batch 1 - Expiry Date: 1st Jan 2020;  Quantity: 30, <br> Batch 2 - Expiry Date: 1st Feb 2020;  Quantity: 20, <br> Batch 3 - Expiry Date: 1st Mar 2020;  Quantity: 40, <br> FEFO for order fulfilment (First Expiry First Out) followed. <br> If an order is placed for 40 units of cooking masala, which batch will sent in what quantity?</h2> 
           </div>
        </div>
       ...
       <div class="quiz-choice correct-q1">
         <p> Batch 1: 30; Batch 2: 10</p>
       </div>
       <div class="quiz-choice wrong-q1">
         <p> Batch 2: 30; Batch 3: 10</p>
       </div>
       <div class="quiz-choice wrong-q1">
         <p> Batch 1: 30; Batch 3: 10</p>
       </div>
       <div class="quiz-choice wrong-q1">
         <p> Batch 3: 40</p>
       </div>
    ...
    <div id="ex1" class="modal">
      ...
      <h3>Since Batch 1 expires first, batch 1 units are to be sent first. All 30 units are processed against the order. For the remaining 10 units, Batch 2 is sent as the next batch that expires first is Batch 2.</h3>
      <br>
      <hr>
    ...
    $.confirm({
        ...
        buttons: {
            tryAgain: {
                ...
                btnClass: 'btn-green',
                action: function(){
                  window.location = "{{url()}}/Unit5Module1Timer5";  
                }
            },
        }
    });
  ...
  $('.wrong-q1').click(function(){
    $.confirm({
		...
		text: 'Back to Concept',
                btnClass: 'btn-red',
                action: "{{url()}}/Unit5Module1Concept2",
                action: function(){
                 window.location = "{{url()}}/Unit5Module1Concept2";
                }
