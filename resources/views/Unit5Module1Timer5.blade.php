 ...
 <div class="hours">
  ...
  <div class="card">
      ...
      <div class="row" style="margin-left: 3%">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
           <div id="question-one" class="quiz-ans-container" style="padding-bottom: 60px;padding-top: 5px;">
            <h2 style="text-align:-webkit-left;font-family: 'Lora', serif;"><span style="margin-left: -44px;">Q2. </span>Four batches of Cooking masala are received in a warehouse <br>Received Date: 10th Jan 2020; Batch 1 - Manufacturing Date: 1st Jan 2020; Shelf Life: 3 months <br>Received Date: 1st Feb  2020; Batch 2 - Manufacturing Date: 10th Jan 2020; Shelf Life: 2 months <br>Received Date: 1st March  2020; Batch 3 - Manufacturing Date: 1st Feb 2020; Shelf Life: 3 months <br>Received Date: 1st March 2020; Batch 4 - Manufacturing Date: 3rd Feb Jan 2020; Shelf Life: 2 months <br>If Batch 2 is sent out first, which method is followed?</h2> 
           </div>
        </div>
    ...
    <div id="ex1" class="modal">
      ...
      <h3>Expiry Dates:<br>Batch 1 - 31st March 2020<br>Batch 2: 10th March 2020<br>Batch 3: 20th April 2020<br>Batch 4: 3rd April 2020</h3>
      <h3 style="font-weight: bold;">Step-2</h3>
      <h3>Batch 2 expires first. Basis FEFO, Batch 2 should be sent first.</h3>
      <br>
      <hr>
