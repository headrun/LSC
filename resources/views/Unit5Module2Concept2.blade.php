    ...
    <div class="container">
        <div class="row" style="color: #7d929d;">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style=" font-size:22px;">
                ...
                <p>MHE can be of various types</p>
                <p>a) Transport Equipment</p>
                <p>b) Positioning Equipment</p>
                <p>c) Loading Equipment</p>
                <p>d) Storage Equipment</p>
                <br>
                <p>Transport Equipment are genrally used for movement within or outside warehouse.</p>
                <p><b>Some of transport equipments are Conveyers, Electric Tugs, Cranes and Industrial Trucks.</b></p>
                <br>
                <p><b>Insudtrial Trucks are either manual or battery operated.</b></p>
                <p>Hand Pulling Trolleys, Battery Operated Pulling Trolleys, Forklift, Pallet Jacks, Reach trcuk are examples.</p>
            </div>
        ...
        <div class="row">
         <input type="submit" style="font-size: 15px;" id="submit" value="Go to Next Module">
       </div>
    </div>
</div>
</div>
