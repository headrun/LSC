...
<div class="container-fluid">
   ...
   <div class="row" > 
     <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5" align="center">
      <img src="{{asset('assets/img/U5M2_18.png')}}" width="250px;" height="200px;">
     </div>
     <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
      <h4>Carton Flow:</h4>
      <br>
      <p><span>&#10004;</span> Utilizes shelves equipped with rollers or wheels that allow materials to flow from the back of rack to front</p>
      <p><span>&#10004;</span> Ideal for small-quantity case picking & FIFO system</p>
     </div>
   </div>
<br><br>
   <div class="row"> 
     <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5" align="center">
      <img src="{{asset('assets/img/U5M2_19.png')}}" width="250px;" height="200px;">
     </div>
     <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
      <h4>Ground Pallet:</h4>
      <br>
      <p><span>&#10004;</span> Storage pallets are stored on the floor arranged in lanes</p>
      <p><span>&#10004;</span> Depth of a lane is the number of pallets stored back-to-back away from the pick aisle</p>
      <p><span>&#10004;</span> Height of a lane is normally measured as the number of pallets that can be “stacked” one on top of each other</p>
     </div>
   </div>
