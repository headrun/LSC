...
<div class="container-fluid">
   ...
   <div class="row" align="center"> 
     <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
      <p>Transportation</p>
      <img src="{{asset('assets/img/U5M2three.png')}}" width="220px;" height="220px;">
     </div>
     <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
      <p>Loading/ Unloading</p>
       <img src="{{asset('assets/img/U5M2four.png')}}" width="220px;" height="220px;">
     </div>
     <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
       <p>Storage</p>
       <img src="{{asset('assets/img/U5M2five.png')}}" width="220px;" height="220px;">
     </div>
     <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
      <p>Positioning</p>
       <img src="{{asset('assets/img/U5M2six.png')}}" width="220px;" height="220px;">
     </div>
