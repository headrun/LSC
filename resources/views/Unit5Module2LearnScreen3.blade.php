...
<div class="container-fluid">
   ...
   <div class="row" > 
     <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5" align="center">
      <img src="{{asset('assets/img/U5M2seven.png')}}" width="250px;" height="200px;">
     </div>
     <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
      <h4>Fork Lift:</h4>
      <br>
      <p><span>&#10004;</span> Powered vehicle with a forked platform at front that can be raised or lowered for insertion under a cargo to lift it</p>
     </div>
   </div>
<br><br>
   <div class="row"> 
     <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5" align="center">
      <img src="{{asset('assets/img/U5M2eight.png')}}" width="250px;" height="200px;">
     </div>
     <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
      <h4>Reach Stacker:</h4>
      <br>
      <p><span>&#10004;</span> To transport a container for short distances very quickly and pile them in various rows depending on its access</p>
      <p><span>&#10004;</span> Flexible & higher stacking capacity</p>
     </div>
   </div>
