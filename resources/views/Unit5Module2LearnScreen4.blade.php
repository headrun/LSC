...
<div class="container-fluid">
   <div class="row" style="background-color: white;">
     <h2 align="center" style="color: #26e66ad4"><b>Loading/ Unloading Equipment<b> </h2>
   </div>
   <br><br>
   <div class="row" > 
     <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5" align="center">
      <img src="{{asset('assets/img/U5M2nine.png')}}" width="250px;" height="200px;">
     </div>
     <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
      <h4>Pallet:</h4>
      <br>
      <p><span>&#10004;</span> Flat structured tool with a bottom deck, which supports to load, unload, move or store the goods in a stable position</p>
     </div>
   </div>
<br><br>
   <div class="row"> 
     <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5" align="center">
      <img src="{{asset('assets/img/U5M2ten.png')}}" width="250px;" height="200px;">
     </div>
     <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
      <h4>Reach Truck:</h4>
      <br>
      <p><span>&#10004;</span> Right-angle stacking truck designed for unit load handling with rack interface</p>
      <p><span>&#10004;</span> Operate in narrow aisles and used best for loading/ unloading pallets in racks</p>
     </div>
   </div>
...
if (event.keyCode === 40) {
   ...
   next = next+1;
   if(next == 1){
    window.location = "{{url()}}/Unit5Module2LearnScreen5";
   }
  }
   ...
   next = next-1;
   if(next == -1){
   window.location = "{{url()}}/Unit5Module2LearnScreen3";
   }
  }
});
