...
<div class="container-fluid">
   ...
   <div class="row" > 
     <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5" align="center">
      <img src="{{asset('assets/img/U5M2_11.png')}}" width="250px;" height="200px;">
     </div>
     <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
      <h4>Hand Truck (HT) Pulling Trolley:</h4>
      <br>
      <p><span>&#10004;</span> L-shaped box-moving handcart with handles at one end, wheels at the base, with a small ledge to set objects on, flat against the floor when the hand-truck is upright</p>
     </div>
   </div>
<br><br>
   <div class="row"> 
     <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5" align="center">
      <img src="{{asset('assets/img/U5M2_12.png')}}" width="250px;" height="200px;">
     </div>
     <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
      <h4>Battery Operated Pulling Trolley:</h4>
      <br>
      <p><span>&#10004;</span> Ideal for moving heavy loads safely and easily.</p>
      <p><span>&#10004;</span> Longer service life & high performance</p>
     </div>
   </div>
...
if (event.keyCode === 40) {
   ...
   next = next+1;
   if(next == 1){
    window.location = "{{url()}}/Unit5Module2LearnScreen6";
   }
  }
   ...
   next = next-1;
   if(next == -1){
   window.location = "{{url()}}/Unit5Module2LearnScreen4";
   }
  }
});
