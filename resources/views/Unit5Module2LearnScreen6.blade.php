...
<div class="container-fluid">
   ...
   <div class="row" > 
     <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5" align="center">
      <img src="{{asset('assets/img/U5M2_13.png')}}" width="250px;" height="200px;">
     </div>
     <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
      <h4>Conveyors:</h4>
      <br>
      <p><span>&#10004;</span> Used when material is to be moved frequently between specific points over a fixed path</p>
      <p><span>&#10004;</span> Viable when there is a sufficient flow volume to justify the fixed conveyor investment</p>
     </div>
   </div>
<br><br>
   <div class="row"> 
     <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5" align="center">
      <img src="{{asset('assets/img/U5M2_14.png')}}" width="250px;" height="200px;">
     </div>
     <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
      <h4>Cranes:</h4>
      <br>
      <p><span>&#10004;</span> Used to transport loads over variable (horizontal and vertical) paths within a restricted area</p>
      <p><span>&#10004;</span> Provide flexibility in movement as loads handled can be more varied with respect to their shape and weight</p>
     </div>
   </div>
