...
<div class="container-fluid">
   ...
   <div class="row" > 
     <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5" align="center">
      <img src="{{asset('assets/img/U5M2_15.png')}}" width="450px;" height="400px;">
     </div>
     <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
      <h4>Racks:</h4>
      <br>
      <p><span>&#10004;</span> Racking is the utilization of height & depth</p>
      <br>
      <p><span>&#10004;</span> Steel structure composed of two or more upright frames, beams, and connectors for the purpose of supporting materials in storage</p>
      <br>
      <p><span>&#10004;</span> Provide accessibility for order picking and useful in organizing the flow of product in warehouse</p>
      <br>
      <p><span>&#10004;</span> Multiple levels – Ground + 1, Ground +2, … Ground + n 🡪 Store maximum products in a small amount of space</p>
     </div>
   </div>
<br><br>
...
if (event.keyCode === 40) {
   ...
   next = next+1;
   if(next == 1){
    window.location = "{{url()}}/Unit5Module2LearnScreen8";
   }
  }
