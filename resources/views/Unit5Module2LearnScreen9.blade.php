...
<div class="container-fluid">
   ...
   <div class="row" > 
     <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5" align="center">
      <img src="{{asset('assets/img/U5M2_17.png')}}" width="450px;" height="400px;">
     </div>
     <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
      <h4>Shelving:</h4>
      <br>
      <p><span>&#10004;</span> Designed for areas where products are hand loaded instead of on a pallet</p>
      <br>
      <p><span>&#10004;</span> Shelf material can be particleboard shelving, wire decks or solid steel panels</p>
      <br>
      <p><span>&#10004;</span> Shelves help pickers find products more quickly and avoid mis-picks or mis-counts</p>
      <br>
      <p><span>&#10004;</span> Reduces the number of accidents that take place in a workplace</p>
     </div>
   </div>
<br><br>
