...
.jquery-modal{z-index: 11111;}
   ...
   <div class="row" style="margin-left: 10%">
     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="color: white;">
       ...
       <h2 style="text-align: -webkit-left;font-style: ">
        ...
        <span style="font-family: 'Lora', serif;">Which of the following Material Handling Equipments (MHE) can handle a pallet?</span></h2>
     </div>
   </div>
   ...
   <div class="row">
     <div class="col-md-12 col-sm-12" style="color: white;">
       ...
       <p style="margin-top: 45px;"> Forklifts</p>
       </div>
       <div class="quiz-choice wrong-q1">
       <p style="margin-top: 45px;"> Pallet Jacks</p>
       </div>
       <div class="quiz-choice correct-q1">
       <p style="margin-top: 45px;"> a & b</p>
       </div>
       <div class="quiz-choice wrong-q1" style="margin-right: 20px;">
       <p style="margin-top: 45px;"> Neither a nor b</p>
       </div>
     </div>
   </div>
   ...
   <div id="ex1" class="modal">
     ...
     <h3 id="step">Step-1</h3>
      <h3>Pallet Jacks and Forklift can handle pallet movement.</h3>
...
$(document).on('click', '.concept', function(){
    $.ajax({
          ...
          success: function(response) {
            console.log('success');
            window.location = "{{url()}}/Unit5Module2Concept2";
          }
    });
});
$( ".open" ).click(function() {
