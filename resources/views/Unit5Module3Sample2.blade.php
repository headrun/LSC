...
.jquery-modal{z-index: 11111;}
   ...
   <div class="row" style="margin-left: 10%">
     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="color: white;">
       ...
       <h2 style="text-align: -webkit-left;font-style: ">
        ...
        <span style="font-family: 'Lora', serif;">When a worker is exposed to inhalation hazards, which of thw following is useful?</span></h2>
     </div>
   </div>
   ...
   <div class="row">
     <div class="col-md-12 col-sm-12" style="color: white;">
       ...
       <p style="margin-top: 30px;"> Respirators</p>
       </div>
       <div class="quiz-choice wrong-q1">
       <p style="margin-top: 30px;"> Hard Hats</p>
       </div>
       <div class="quiz-choice wrong-q1">
       <p style="margin-top: 30px;"> Chemical Resistan Goggles</p>
       </div>
       <div class="quiz-choice wrong-q1" style="margin-right: 20px;">
       <p style="margin-top: 30px;"> Gloves</p>
       </div>
     </div>
   </div>
   ...
   <div id="ex1" class="modal">
     ...
     <h3 id="step">Step-1</h3>
      <h3>Respiration protection PPE are used in case worker is exposed to inhalation or posionous gases release scenarios and hazards.</h3>
      <br>
      <hr>
...
$(document).on('click', '.concept', function(){
    $.ajax({
          ...
          success: function(response) {
            console.log('success');
            window.location = "{{url()}}/Unit5Module3Concept2";
          }
    });
});
$( ".open" ).click(function() {
