 ...
 <div class="hours">
  ...
  <div class="card">
      ...
      <div class="row" style="margin-left: 3%">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
           <div id="question-one" class="quiz-ans-container" style="padding-bottom: 60px;padding-top: 5px;">
            <h2 style="text-align:-webkit-left;font-family: 'Lora', serif;"><span style="margin-left: -44px;">Q1. </span>Which is preferred metyhod of picking in a online e commerce industry?</h2> 
           </div>
        </div>
    ...
    <div id="ex1" class="modal">
      ...
      <h3>If multiple orders have same product, pickers tend to collate all orders to pick the total required quantity for the product. They wil later segregate it at order level. This process is called batch picking.</h3>
      <br>
      <hr>
    ...
    $.confirm({
        ...
        buttons: {
            tryAgain: {
                ...
                btnClass: 'btn-green',
                action: function(){
                  window.location = "{{url()}}/Unit5Module3Sample2";  
                }
            },
        }
    });
  ...
  $('.wrong-q1').click(function(){
    $.confirm({
		...
		text: 'Back to Concept',
                btnClass: 'btn-red',
                action: "{{url()}}/Unit5Module3Concept1",
                action: function(){
