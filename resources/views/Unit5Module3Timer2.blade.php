 ...
 <div class="hours">
  ...
  <div class="card">
      ...
      <div class="row" style="margin-left: 3%">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
           <div id="question-one" class="quiz-ans-container" style="padding-bottom: 60px;padding-top: 5px;">
            <h2 style="text-align:-webkit-left;font-family: 'Lora', serif;"><span style="margin-left: -44px;">Q2. </span>A worker working in rakcing system picking has a potential problem: Material stored are in high locations and very heavy. Which is a mandatory PPE?</h2> 
           </div>
        </div>
    ...
    <div id="ex1" class="modal">
      ...
      <h3>Workers in environemnts of falling or flying objects need to have head and eye protection PPE. Hard Hats is a head protection PPE.</h3>
      <br>
      <hr>
  ...
  $('.wrong-q1').click(function(){
    $.confirm({
		...
		text: 'Back to Concept',
                btnClass: 'btn-red',
                action: "{{url()}}/Unit5Module3Concept2",
                action: function(){
