...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
    <div class="container" >
       <div>
        <h1>Hi {{ Session::get('user_name') }}, Welcome to Logistics Videos Module</h1>
       </div>
       <br><br>
	<div class="row">
...
$(document).on('click', '#transportation', function(){
   window.location = "{{url()}}/TransportationVideo1";      
});

$(document).on('click', '#fundamentalsOfLogistics', function(){
   window.location = "{{url()}}/WarehouseSimulatorSecond1";      
});

$(document).on('click', '#distribution', function(){
   window.location = "{{url()}}/Unit3Video1";
});
