        ...
        <div class="row">
          <div class="col-xs-12 col-lg-7 col-md-7 col-sm-7">
            <div class="videoimage">
              <video id="myVideo1" width="100%" height="354px" poster="newcss/images/slide1.jpg">
                <source src="newcss/images/AutomatedWarehouse-FullSimulation.mp4" type="video/mp4">
...
WATCH</a></div>
        <div class="stop" onclick="pauseVid()" style="display:none;"><a href="#"><i class="fas fa-stop-circle" aria-hidden="true"></i>
          ...
          <div class="col-xs-12 col-lg-5 col-md-5 col-sm-5">
            <div class="videotext">
              <h1>Automated Warehouse-Full Simulation </h1>
              <div class="list">
                2019&nbsp;&nbsp;|&nbsp;&nbsp;05:10 &nbsp;&nbsp;|&nbsp;&nbsp;18+
              </div>
              <p>The model is used to study the effects of four different AS/RS configurations, large and small holding pallets, and four sizes of stored items on the system performance.</p>
