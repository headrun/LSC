        ...
        <div class="row">
          <div class="col-xs-12 col-lg-7 col-md-7 col-sm-7">
            <div class="videoimage">
              <video id="myVideo1" width="100%" height="100%" poster="newcss/images/slide2.jpg">
                <source src="newcss/images/the_doosan_intelligent_concept_forklift_hq_sMrb0oozJWg_360p.mp4" type="video/mp4">
              </video>
            </div>
...
WATCH</a></div>
        <div class="stop" onclick="pauseVid()" style="display:none;"><a href="#"><i class="fas fa-stop-circle" aria-hidden="true"></i>
          ...
          <div class="col-xs-12 col-lg-5 col-md-5 col-sm-5">
            <div class="videotext">
              <h1>The Doosan Intelligent Concept Forklift</h1>
              <div class="list">
                2019&nbsp;&nbsp;|&nbsp;&nbsp;04:40 &nbsp;&nbsp;|&nbsp;&nbsp;25+
              </div>
              <p>Largest Manufacturer Forklifts in South Korea. More Than 90 Forklift Models. Safety Reliability Value. Parts Availability. Authorized Doosan Dealer.</p>
