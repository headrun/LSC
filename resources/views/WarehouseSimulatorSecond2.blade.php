       ...
       <div class="row">
         ...
         <div class="col-xs-12 col-lg-7 col-md-7 col-sm-7">
           <div class="videoimage">
             <video id="myVideo1" controls width="100%" height="354px" poster="newcss/images/thumbnail2.png">
               <source src="newcss/images/orders.mp4" type="video/mp4">
...
<div class="wat" align="right" style="bottom: 52px;position: absolute;"><a href="/WarehouseSimulatorSecond1">Previous Page</a></div>
<div class="watc" align="right" style="bottom: 52px;position: absolute;"><a href="/WarehouseSimulatorSecond3">Next Page</a></div>
</div>
</div>
</body>
