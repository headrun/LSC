       ...
       <div class="row">
         ...
         <div class="col-xs-12 col-lg-7 col-md-7 col-sm-7">
           <div class="videoimage">
             <video id="myVideo1" controls width="100%" height="354px" poster="newcss/images/thumbnail3.png">
...
<div class="wat" align="right" onclick="previous()" style="bottom: 52px;position: absolute;"><a href="/WarehouseSimulatorSecond2">Previous</a></div>
