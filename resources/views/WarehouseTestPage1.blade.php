...
<body>
    <div class="container">
        <div class="card">
                <span style="font-size: 28px;line-height: 28px;color: #7d929d;">Basics of Warehousing</span>
                <hr>
                <div style="background: #eaedf0;padding: 10px;border-radius:4px;">
                  <p style="color: #3f464c;font-family: 'Varela Round','ProximaRegular', Helvetica, Arial, sans-serif;">Number of Questions:<span style="color: #4dbfbf;"> 7</span></p>
                  <p style="color: #3f464c;font-family: 'Varela Round','ProximaRegular', Helvetica, Arial, sans-serif;">Time Limit:<span style="color: #4dbfbf;"> 28 m 0 s</span></p>
                </div>
                <hr>
...
<script>
    ...
    function Decrement() {
        if (document.getElementById) {
            ...
            if (mins < 0) {
                window.location = "{{url()}}/submitQuiz/?subject=Distribution&module=Warehouse1";
                alert('time up');
                minutes.value = 0;
                seconds.value = 0;
            }
...
<script>
 ...
 var nextHide;
   var AllQuestions = {
           ...
           {
               name:"True or False: Proximity to customers is not a reason to establish warehouse.",
               A: 'TRUE',
               B: 'FALSE',
               C: '',
               D: ''
           ...
           {
               name:"Warehouse that is 10,000 Sqft in size has a rental cost of 10 Rs/Sqft/Month and handling charges of 50 Rs per ton. If the warehouse handles 1000 tonnes every month, what is the total warehousing cost?",
               A: '1,00,000 Rs',
               B: '1,50,000 Rs',
               C: '50,000 Rs',
               D: '2,00,000 Rs'
           ...
           {
               name:"Certain production units runs continuously without a break. Why is warehouses needed in this scenario?",
               A: 'Production is continuous. Sales in not. Hence storage of products until it reaches customer is mandatory',
               B: 'No relation between warehouse and production',
               C: 'Continuous production units directly serve customers',
               D: 'None of the above'
           },
           {
               name:"Bangalore warehouse is 1000 KM away from Mumbai customer. If truck from Bangalore runs for 10 hours per day and runs at 50 KM per hour, how many days does it take for material to reach Mumbai?",
               A: '1 day',
               B: '3 days',
               C: '2 days',
               D: '5 days'
           ...
           {
               name:"Which of the following is not a factor to determine warehouse location?",
               A: 'Organizational hierarchy of company',
               B: 'Availability of human resources in the locality for employment',
               C: 'Proximity to customers',
               D: 'Land availability and layout possibility'
           },
           {
               name:"Which of the following is not a storage system classification?",
               A: 'Unit Loads',
               B: 'Bulk storage for solids',
               C: 'Pallet storage',
               D: 'Floor space'
           }]
   };
