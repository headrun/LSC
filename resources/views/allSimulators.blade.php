       ...
       <div class="row">
         ...
         <div class="col-xs-12 col-lg-7 col-md-7 col-sm-7">
           <div class="videoimage">
             <video id="myVideo1" width="100%" height="354px" poster="images/slide1.jpg">
             </video>
           </div>
...
<div class="wat" align="right" style="bottom: 52px;position: absolute;"><a href="#" onclick="previousFun()">Previous Page</a></div>
<div class="watc" align="right" style="bottom: 52px;position: absolute;"><a href="#" onclick="nextFun()">Next Page</a></div>
</div>
</div>
</body>
...
<script type="text/javascript">
   ...
   var nextHide;
   var previous;
   var data = ["newcss/images/logistics.mp4","newcss/images/orders.mp4","newcss/images/shipping.mp4"];
   $('.wat').hide();
   getSimulators(indexId);
  ...
  function getSimulators(index) {
    var html = '';
    html += '<source src='+ data[index] +' type="video/mp4"><source src="newcss/images/AutomatedWarehouse-FullSimulation.webm" type="video/webm">';
    $('#myVideo1').html(html);
    indexId = index;
    previous = index;
    nextHide = data.length; 
  }
