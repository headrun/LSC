...
font-size: 17px;
    ...
    <div class="container">
     <h1 style="text-align: center;font-family: monospace;">WAREHOUSE LOCATION</h1>
      <div class="card">
    <div class="container">
        <div class="row" style="color: #7d929d;">
            
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12" style="font-size:22px;">
              <img src="{{asset('assets/img/concept2.png')}}" alt="Image" style="margin-left: 20px;margin-top: 4%;">  
            </div>
...
<script type="text/javascript">
  $(document).on('click', '#submit', function(){
    window.location = "{{url()}}/Distribution/Module2/Timer2";
  });
</script>   
@stop
