 ...
 z-index: 11111;
   ...
   <div class="row" style="margin-left: 7%">
     <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" style="color: white;">
       ...
       <h2 style="text-align: -webkit-left;"> <span style = "margin-left:-52px;">Q1.</span><span style="font-family: monospace;"> An apparel major has a Chennai customer who requires ordered material to be supplied in 3 days. If a truck can travel 70 Km per day at a maximum, whioch of the following cities are good for warehouse establishment?</span></h2>
     </div>
   </div>
   ...
   <div class="row">
     <div class="col-md-12 col-sm-12" style="color: white;">
       ...
       <p> a)<br> Bangalore 300 KM away</p>
       </div>
       <div class="quiz-choice wrong-q1">
       <p> b) Kanchipuram 50 KM away</p>
       </div>
       <div class="quiz-choice wrong-q1" style="margin-right: 20px;">
       <p> c) Sriperumbathur 100 KM away</p>
       </div>
     </div>
   </div>
   <div class="row">
...
<div id="ex1" class="modal">
 ...
 <h3>Maximum distyance that can be covered in 3 days: 210 KM.</h3>
 <h3 style="font-weight: bold;">Step-2</h3>
 <h3>Both Kanchipuram and Sriperumbathur are less than 210 KM away from Chennai.</h3>
 <br>
 <hr>
