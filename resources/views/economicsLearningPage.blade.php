                ...
                <div class="card" id ="module2">
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
                            <h3>Supply</h3>
                            <br>
                            <p>Supply is an economic term that refers to the amount of a given product or service that suppliers are willing to offer to consumers at a given price level at a given period.</p>
                        </div>
                    </div>
                </div>        
            </div>
...
<script type="text/javascript">
  $(document).on('click', '#module1', function(){
    window.location = "{{url()}}/Economics/Module1_Theory";
  });
  $(document).on('click', '#module2', function(){
    window.location = "{{url()}}/Economics/Module2_Theory";
  });
  $(document).on('click', '#module3', function(){
    window.location = "{{url()}}/Economics/Module3_Theory";
  });
  $(document).on('click', '#module4', function(){
    window.location = "{{url()}}/Economics/Module4_Theory";
  });
