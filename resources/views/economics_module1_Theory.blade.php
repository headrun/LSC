    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8 col-sm-12" style="font-size:22px;color: #7d929d;">
                ...
                <p><b>Demand is directly proportional to the number of end-users .</b> </p>
		...
		<p><b>What is the percentage increase in total demand if 10 more students are joining the camp for 2 days?</b></p>
                ...
                <p><b>Average demand = Total demand / No. of days. Here, average demand is 30.</b></p>
            </div>
            <div class="col-md-4 col-sm-12">
	 	<img src="{{url()}}/images/economics/demand_concept1.png" width="300px" height="300px" alt="Concept">
                <img src="{{url()}}/images/economics/demand_new_concept.jpg" width="300px" height="300px" alt="Concept">  
                <img src="{{url()}}/images/economics/demand_concept3.jpg" width="300px" height="300px" alt="Concept">
                <br>
                <br>
                <br>
