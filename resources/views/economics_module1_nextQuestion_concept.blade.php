...
<head>
    ...
    <link rel="stylesheet" href="{{url()}}/css/averageconcept.css">
    <style>
    ...
    <body style="background-color:white;">
        <header class="header_area" style="height:48px;">
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    <!-- Brand and toggle get grouped for better mobile display -->
                    <!-- <a class="navbar-brand logo_h" href="index.html"><img src="http://stockone.in/wp-content/uploads/2017/12/stockone-logo-white.png" height="40px;" width="220px;" alt=""></a> -->
    ...
    <div class="container">
        <div class="row" style="margin-top: 40px;">
            ...
            <div class="col-md-8 col-sm-12" style="color: #7d929d; font-size: 18px;">
                <h1 style="color: aqua;">Economics next qsn concept</h1>
...
$(document).on('click', '#submit', function(){
    $.ajax({
          ...
          success: function(response) {
            console.log('success');
            window.location = "{{url()}}/Economics/Module1/next_question/Timer";
          }
    });
});
</script>
