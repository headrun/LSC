...
<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
   ...
   padding-top: 5px;">
     <h2 style="text-align:-webkit-left;"><span style="margin-left: -44px;">Q1.</span>Economics module 1 next qsn's timer qsn
     </h2>
    ...
    $.confirm({
        ...
        buttons: {
            tryAgain: {
                ...
                btnClass: 'btn-red',
		action: function(){
		   window.location = "{{url()}}/Economics/Module1/next_question/Concept";
                 }
            },
        }
    });
