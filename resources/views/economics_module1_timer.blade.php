...
<!-- <div class="largeCircle">
 ...
 <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
   ...
   padding-top: 5px;">
     <h2 style="text-align:-webkit-left;font-family: monospace;"><span style="margin-left: -44px;">Q1.</span>Jay sells Christmas trees in an apartment. He bought 200 trees on December 1st and sold 75 trees in 15 days. He finished selling all the trees by Christmas. What is the average demand of Christmas trees, per day in the first 15 days and the overall average demand per day ?</h2>
     
   </div>
 </div>
 <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="padding-top: 51px">
  ...
  $('.wrong-q1').click(function(){
    $.confirm({
		...
		text: 'Back to Concept',
                btnClass: 'btn-red',
                action: "{{url()}}/Economics/Module1/Concept",
                action: function(){
