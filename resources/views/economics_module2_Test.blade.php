...
<script>
    ...
    function Decrement() {
        if (document.getElementById) {
            ...
            if (mins < 0) {
                window.location = "{{url()}}/submitQuiz/?subject=Fundamentals Of Logistics&module=Planning";
                alert('time up');
                minutes.value = 0;
                seconds.value = 0;
            }
...
<script>
 ...
 var nextHide;
   var AllQuestions = {
           ...
           {
               name:"Audo sound systems import their speakers from USA. Order is placed in January for April, May and June requirement of Audo sound systems. April,May,June demand is 500, 1000, 1000 units respectively. How many units are ordered in January is Audo order 20% extra speakers than required amount?",
               A: '3000',
               B: '2000',
               C: '2500',
               D: '5000'
           ...
           {
               name:"CreationsIndia limited makes 300 liters of preservatives every month which exactly meets annual demand. If September, October and November is the peak season contributing to 50% of annual demand. What is the average demand per month during non-season?",
               A: '200 liters per month',
               B: '1800 liters per month',
               C: '900 liters per month',
               D: 'None of the above'
           }]
   };
 function nextFun() {
