 ...
 z-index: 11111;
   ...
   <div class="row" style="margin-left: 7%">
     <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" style="color: white;">
       ...
       <h2 style="text-align: -webkit-left;"> <span style = "margin-left:-52px;">Q1.</span><span style="font-family: monospace;"> At Ruby's potluck where they are bringing pulpy orange juice, we found out that 120 oranges were required for 48 persons. Radha bought 145 oranges from the market.
How many glasses of juice can they make from the extra oranges?</span></h2>
     </div>
   </div>
...
<div id="ex1" class="modal">
 ...
 <h3>There are 48 students in class and consider each student requires one glass of juice</h3>
 <h3 style="font-weight: bold;">Step-2</h3>
 <h3>120 Oranges required to make 48 Glasses of juice (Given)</h3>
 <h3 style="font-weight: bold;">Step-3</h3>
 <h3>To make one glass of juice, Oranges required = 120/48  i.e, 2.5 Oranges</h3>
 <h3 style="font-weight: bold;">Step-4</h3>
 <h3>Radha bought 145 oranges from the market</h3>
 <h3 style="font-weight: bold;">Step-5</h3>
 <h3>Extra Oranges = 145-120  i.e, 25</h3>
 <h3 style="font-weight: bold;">Step-6</h3>
 <h3>How many glasses of juice will make with 25 oranges i.e, 25/2.5 i.e, 10</h3>
 <br>
 <hr>
...
<script type="text/javascript">
  $(document).on('click', '.concept', function(){
    window.location = "{{url()}}/Economics/Module2/Concept";
  });
</script>
@stop
