...
font-size: 17px;
    ...
    <div class="container">
     <h1 style="text-align: center;font-family: monospace;">INVENTORY</h1>
     <div class="card">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8 col-sm-12" style="color: #7d929d;font-size:22px;">
                ...
                <p><b>Once Ron and friends were back to school from the Scouting camp, they decided to conduct an ice-cream party for all the 90 students and 10 teachers who participated in the camp.  They reserved 100 icecreams from a nearby shop, but decided to take icecreams in two batches from the shop. 
</b> </p>
                <br>
		<p>In the first batch, Ron took 60 icecreams .</p>  
                <p>
                "Total inventory = 100
<br>Opening inventory = 60"
</p>
...
<br>Closing inventory = 50 - 30 + 0 = 20</p>
            ...
            <div class="col-md-4 col-sm-12">
                <img src="https://ae01.alicdn.com/kf/HTB1zUJ1oeuSBuNjSsziq6zq8pXaf/TOFOCO-Kawaii-Coffee-Cup-Ice-Cream-Squishy-Jumbo-Slow-Rising-Toys-Antistress-Decorate-Cake-Squishies-Food.jpg" width="300px" height="300px" alt="Concept">
                <br>
                <br>
                <br>
