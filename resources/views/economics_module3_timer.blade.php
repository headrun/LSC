...
<!-- <div class="largeCircle">
 ...
 <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
   ...
   padding-top: 5px;">
     <h2 style="text-align:-webkit-left;font-family: 'Lora', serif;"><span style="margin-left: -44px;">Q1. </span>Ram wants to leave his bike with empty petrol tank. His bike has a mileage of 30 km/ltr and has 1 ltr of petrol now. He is going to ride his bike for 120 kms today. How many litres should he fill now?</h2>
     
   </div>
 </div>
 <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="padding-top: 100px">
    <img src="https://newvitruvian.com/images/pump-clipart-fuel-13.jpg">
 </div>
</div>
  ...
  $('.wrong-q1').click(function(){
    $.confirm({
		...
		text: 'Back to Concept',
                btnClass: 'btn-red',
                action: "{{url()}}/Economics/Module3/Concept",
                action: function(){
