...
<!-- <div class="largeCircle">
 ...
 <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
   <div id="question-one" class="quiz-ans-container" style="padding-bottom: 60px;padding-top: 5px;">
     <h2 style="text-align:-webkit-left;font-family: 'Lora', serif;"><span style="margin-left: -44px;">Q1. </span>Toy Car Pvt. Ltd sells remote controlled toy cars online through Amazon and Flipkart. It has 200 units in stock. Sales per day through Amazon and Flipkart are expected to be 3 units and 2 units respectively. What is the expected days of Inventory cover? 
During summer vacation,  actual sales became twice the expected sales. What is the actual days of inventory cover?</h2>
     
   </div>
 </div>
 <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="padding-top: 100px">
    <img src="https://www.highreshdwallpapers.com/wp-content/uploads/2014/01/Disney-HD-Lightning-McQueen-Wallpaper.jpg">
 </div>
</div>

<div class="quiz-choice wrong-q1">
       <p> Expected:40 days,    Actual: 80 days</p>
     </div>
     <div class="quiz-choice wrong-q1">
       <p> Expected:40 days,    Actual: 40 days</p>
     </div>
     <div class="quiz-choice correct-q1">
       <p> Expected:40 days,    Actual: 20 days</p>
     </div>
     <div class="quiz-choice wrong-q1">
       <p> Expected:20 days,    Actual: 40 days</p>
     </div>
  ...
  $('.wrong-q1').click(function(){
    $.confirm({
		...
		text: 'Back to Concept',
                btnClass: 'btn-red',
                action: "{{url()}}/Economics/Module4/Concept",
                action: function(){
