...
<html lang="en">
   ...
   <body class="newbg">
     <div class="activitymap">
      <div class="activity">
         <div class="container">
            <h1>Chennai – 5,000, Coimbatore – 3,000<a style="float:right;" href="finalActivityScreen13" class="back_right"><i class="fa fa-angle-left" aria-hidden="true"></i>
 Back</a></h1>
...
<!-- <div class="retail1 " style="text-align:center;" >
<ul>
<li>&nbsp;</li>

<li><span>Online</span><div class="input_loc1 " style{width:0} id="ch_result">&nbsp;</div></li>
<li>&nbsp;</li>
</ul>
</div> -->
</div>
...
<li><span>Online</span><div class="input_loc1" id="co_result">&nbsp;</div></li>
<li>&nbsp;</li>
</ul>
</div> -->
</div>
...
<input type="submit" value="Submit" Onclick="Get_Details();"/>
	...
	<h1><span>Congratulations! You have successfully designed network for Big Box.</span><button type="button" class="close" data-dismiss="modal">&times;</button></h1></div>
	<div class="modal-body">

	<p><img src="/finalActivity/images/congratulations-icon.png" alt="congratulations"/></p>
	</div>
...
function Get_Details(){
  // debugger;
	...
	var ch_sum = parseFloat(ch_online)+parseFloat(ch_wholesale);
	var ch_check_online = (parseFloat(5000)*20)/100;
	// var ch_check_retail= (parseFloat(ch_sum)*40)/100;
	var ch_check_wholesale= (parseFloat(5000)*80)/100;
	...
	var co_sum = parseFloat(co_online)+parseFloat(co_wholesale);
	var co_check_online = (parseFloat(3000)*20)/100;
	// var co_check_retail= (parseFloat(co_sum)*40)/100;
	var co_check_wholesale= (parseFloat(3000)*80)/100;
	// var co_check_market =(parseFloat(co_sum)*20)/100;

	if(co_online!=0 && co_wholesale!=0 && ch_online!=0 && ch_wholesale!=0){
    ...
    if(co_sum > 3000 || ch_sum > 5000){
			...
			if(ch_online == ch_check_online && ch_wholesale == ch_check_wholesale && co_online == co_check_online && co_wholesale == co_check_wholesale){
        var url='images/congratulations-icon.png';
        bootbox.alert("<img src='" + url + "'><br/><h1><span>Congratulations! You have successfully designed network for Big Box.</span><button type=\"button\" class=\"close\" data-dismiss=\"modal\">&times;</button></h1>",function(){
              window.location = "finalActivityScreen15";
        });
			}else{
				$("#message").html('<div class="alert alert-danger alert-dismissible"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a><span>Oops! Not all entries are right! Retry</span></div>');
			}
