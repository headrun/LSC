     ...
     <div class="activitymap">
      ...
      <!-- <div class="row justify-content-center"> -->
            <!-- <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12"> -->
              <!-- <div class="branded"> -->
                <!-- <ul> -->
                  <!-- <li><img src="images/online.png" /> <span>Online - <span>20%</span> </span></li> -->
                  <!-- <li><img src="images/wholesale.png" /> <span>Wholesale – <span>80%</span></span></li> -->
            ...
            <div class="navigate" style="margin-bottom:30px;"> <a style="float:right;" href="finalActivityScreen16" class="restart">Go to Next <i class="fa fa-angle-right" aria-hidden="true"></i></a> </div>
