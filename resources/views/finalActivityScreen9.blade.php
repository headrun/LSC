        ...
        <div class="invoice-content">
            <div class="container">
                ...
                <div class="second-question mb-3">
                    ...
                    <h4>Big Box is very particular that FEFO is followed (First Expiry First Out). Which will you pick? Following is your available stock
                    </h4>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg showinganw" role="document">
            <div class="modal-content">
                <div class="modal-body solutionimage">
                    ...
                    <img src="/finalActivity/images/screen7.jpg">
                </div>
            </div>
        </div>
    </div>
        ...
        if (str1 != '' || str2 != '' || str3 != '' || str4 != '') {
            if (str1 == '' && str2 == 50 && str3 == 300 && str4 == 30) {
                swal({
                    ...
                    location.href = 'finalActivityScreen10';
                });
            } else {
                swal({
                    title: "Retry",
