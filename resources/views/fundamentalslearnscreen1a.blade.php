...
<body id="body">
  <div class="container-fluid">
    <div class="row">
        <div>
        <h1 id="heading" class="w3-animate-left" style="text-align: center;font-size: 70px;">LOGISTICS</h1>
        <h2 id = "start" class="w3-animate-left" style="color: red;text-align: center;font-size: 40px;margin-top:30px;">Lets us understand why Logistics is of great importance in today's world</h2>
        </div>
          <h2 id="h2" class="w3-animate-left" style="font-size: 30px;">Logistics refers to all activities performed to ensure that a product or service reaches the destination from origin.</h2>
        ...
        <ul>
          <li id="plan" class="w3-animate-left" style="font-size: 30px;"><span style='font-size:30px;color: white;'>&#10148;</span>Planning</li>
          <li id="move" class="w3-animate-left" style="font-size: 30px;"><span style='font-size:30px;color: white;'>&#10148;</span>Movement</li>
          <li id="hand" class="w3-animate-left" style="font-size: 30px;"><span style='font-size:30px;color: white;'>&#10148;</span>Handling</li>
        </ul>
        <h2 id="h22" class="w3-animate-left" style="margin-top: -15px;font-size: 30px;">of material or service from supply to customer.</h2>
    </div>
    <br><br><br><br><br><br>
