...
<html lang="en">
   ...
   <body>
      ...
      <div class="activity">
         <div class="container">
            <h1><span class="newactivity">Activity:</span> <a style="float:right;" href="/FundamentalLearnScreen1p" class="back_right">Next Page <i class="fa fa-angle-right" aria-hidden="true"></i></a><a style="float:right;margin-right:10px;" href="/FundamentalLearnScreen1o2" class="restart">Restart</a><a style="float:right;" href="/FundamentalLearnScreen1o" class="back_right"><i class="fa fa-angle-left" aria-hidden="true"></i> Back</a></h1>
         </div>
      </div>
      <div class="activity_bg">
         <div class="container">
            ...
            <div class="line2">
               ...
               <div class="left-arrow hidden_element" data-arrow-no="2"><img src="images/left-arrow.png" alt="" /></div>
               ...
               <div class="right-arrow hidden_element" data-arrow-no="1"><img src="images/right-arrow.png" alt="" /></div>
            </div>
            <div class="line3">
               <div class="month">Feb</div>
               <div class="text_data"><input readonly type="text" Value="100"/></div>
               <div class="left-arrow hidden_element"><img src="images/left-arrow.png" alt="" /></div>
               ...
               <div class="right-arrow hidden_element"><img src="images/right-arrow.png" alt="" /></div>
            </div>
            <div class="line4">
            ...
            <div class="line3">
               ...
               <div class="text_data clear_inputs" data-intro-title1="Enter the May Supply such that it meet the exact demand and the closing stock in June will be 0"><input readonly type="text" Value=""/></div>
            ...
            <div class="line4">
               ...
               <div class="text_data clear_inputs" data-intro-title1="Enter the June Supply such that it meet the exact demand and the closing stock in July will be 0"><input readonly type="text" Value=""/></div>
               <div class="text_data1 clear_inputs"><input readonly type="text" Value=""/></div>
               <div class="text_data2 clear_inputs"><input readonly type="text" Value=""/></div>
               <div class="text_data3"><input readonly type="text" Value="180"/></div>
               <div class="text_data4 clear_inputs"><input readonly type="text" Value=""/></div>
            </div>
            <div class="line2">
               <div class="month">July</div>
               <div class="text_data clear_inputs" data-intro-title1="Enter the July Supply such that it meet the exact demand and the closing stock in August will be 0"><input readonly type="text" Value=""/></div>
               <div class="text_data1 clear_inputs"><input readonly type="text" Value=""/></div>
               <div class="text_data2 clear_inputs"><input readonly type="text" Value=""/></div>
               <div class="text_data3"><input readonly type="text" Value="200"/></div>
               <div class="text_data4 clear_inputs"><input readonly type="text" Value=""/></div>
            </div>
            <div class="line4">
               <div class="month">Aug</div>
               <div class="text_data" data-intro-title1="Enter the August Supply such that it meet the exact demand and the closing stock in September will be 0"><input style="visibility:hidden;" readonly type="text" Value="dfdfasdf" /></div>
               <div class="text_data1 clear_inputs"><input readonly type="text" Value=""/></div>
               <div class="text_data2 clear_inputs"><input readonly type="text" Value=""/></div>
               <div class="text_data3"><input readonly type="text" Value="200"/></div>
               <div class="text_data4 clear_inputs"><input readonly type="text" Value=""/></div>
   ...
   <script src="newActivityCss/js/intro.min.js" type="text/javascript"></script>
   <script src="newActivityCss/js/bootbox.min.js" type="text/javascript"></script>
   <script>
