...
<style>
   ...
   <body class="newbg">
     <div class="activitymap">
      <div class="activity">
         <div class="container">
            <h1><span class="newactivity">Activity2</span> <a style="float:right;" href="/FundamentalLearnScreen1s" class="back_right"> Next Page <i class="fa fa-angle-right" aria-hidden="true"></i></a> <a style="float:right;margin-right:10px;" href="/FundamentalLearnScreen1r" class="restart">Restart</a><a style="float:right;" href="/FundamentalLearnScreen1q" class="back_right"><i class="fa fa-angle-left" aria-hidden="true"></i>
 Back</a></h1>
         </div>
      </div>
