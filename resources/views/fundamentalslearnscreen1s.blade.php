...
<div class="container-fluid">
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
     <h1 style="color: #35395c;" class = "ml3">Ready for some questions to validate our understanding ?</h1>
    </div>
  </div>

  <div class="row footer">
      <div class="col-lg-3 col-md-3 col-sm-3">
        <div style="cursor: pointer;padding-bottom:10px;text-align:left;">
...
input.addEventListener("keyup", function(event) {
  ...
  event.preventDefault();
  next = next-1;
  window.location = "{{url()}}/FundamentalLearnScreen1r";
  }
});

$(document).on('click', '#next', function(){
  window.location = "{{url()}}/PlanningPageSlide8";
});
