...
<div class="container-fluid">
    <div class="row" style="background-color: #e5e0ef">
      <div class="col-lg-6 col-md-6 col-sm-6 col-6">
        <img src="{{asset('assets/img/truck.jpg')}}" width="100%" id="image"/>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-6 col-6">
       <div  class="w3-container w3-animate-right" >
<br>
	<h2 style="color: #35395c;">Demand for 1 day: 400 biscuit packets ( 2 packets each for 200 families)<br><br><b style="color: #35395c;">Demand for 3 days: 1200 packets</b></h2>
        <div style="position: fixed;bottom: 12%; display:none ">
          <h2 style="color: #35395c;"> Good! Looks like you are getting the hang of it. Lets learn more.</h2>
	</div>
      </div>
      </div>
    </div>
...
<button class="btn" id="back" style="background-color: #9f59b0;color:white;left:10%;position: absolute; margin-top: 13px;bottom:10px;">Previous Page</button>
    ...
    <div class="col-lg-3 col-md-3 col-sm-3" >
      <div style="cursor: pointer;">
<!--        <img id="next" data-toggle="popover" data-placement="top"  data-content="Good! Looks like you are getting the hang of it. Lets learn more" src="https://img.icons8.com/color/48/000000/right-squared.png" align="right">-->
      </div>
    </div>
  </div>
</div>    
