...
<div class="container-fluid">
   ...
   <div class="row" style="padding: 20px;">
      <h2>However, on Purchase, material need not arrive on the same day.</h2>
      <br>
     <h2>Supplier can be far away, material might not be ready with the supplier, there could be delay in transportation.</h2>
     <br>
     <h2>Let us look at the effect of lead time from supplier to customer on inventory on the same example</h2>
...
if (event.keyCode === 40) {
   ...
   next = next-1;
   if(next == -1){
   window.location = "{{url()}}/inventoryModule2LearnScreen10";
   }
  }
});
