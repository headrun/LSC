...
<div class="container-fluid">
   ...
   <div class="row" style="padding: 20px;">
      <h2>If material gets delayed further, the retailer might be stocked out.</h2>
      <br>
     <h2>Similarly, if demand had gone up beyond expectation, it might have resulted in further extreme cases of stock out</h2>
     <br>
     <h2>An entity should plan inventory considering variation in demand and lead time</h2>
...
if (event.keyCode === 40) {
   ...
   next = next+1;
   if(next == 1){
   window.location = "{{url()}}/inventoryModule2LearnScreen15";
   }
  }
