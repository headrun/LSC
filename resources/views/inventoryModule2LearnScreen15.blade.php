...
<div class="container-fluid">
   ...
   <div class="row" style="padding: 20px;">
      <h2 align="center">Inventory management is a science. Businesses should ensure</h2>
      <br>
     <h2>(a) No stock out situations</h2>
     <h2>(b) Maintain right inventory levels</h2>
     <h2>(c) Do not order in excess to avoid wastage of perishable products or minimize lock of capital in purchasing excess material</h2>
     <h2>(d) Consider demand and lead time changes in inventory</h2>
     <h2>(e) Optimize cost of ordering material (Excess repeated ordering might increase ordering cost)</h2>
     <br>
     <h2 style="color: red;">In short, right inventory at right place at right time , also called Economic Order Quantity is to be calculated</h2>
