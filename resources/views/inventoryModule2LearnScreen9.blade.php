...
<div class="container-fluid">
   ...
   <div class="row" >
    <div style="padding: 20px;">
      <h2>Remember the retailer who ran out of Canned juice boxes? Let us revisit her store. </h2>
      <br>
     <h2>She places order to distributor every day and receives the material the same day</h2>
     <h2>She decides to maintain 10 units of inventory every day. Can you help her how much to order today?</h2>
     <br><br>
