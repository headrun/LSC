...
<script>
    ...
    function Decrement() {
        if (document.getElementById) {
            ...
            if (mins < 0) {
                window.location = "{{url()}}/submitQuiz/?subject=Inventory&module=Inventory terms";
                alert('time up');
                minutes.value = 0;
                seconds.value = 0;
            }
...
<script>
 ...
 var nextHide;
   var AllQuestions = {
           data: [
           {
               name:'A retailer buys 100 units of a new product and sells 20 units in 1 week. What is the closing inventory?',
               A: '80',
               B: '20',
               C: '0',
               D: '100'
           ...
           {
               name:"A fruit vendor has 100 bananas and sells 80 bananas. How manay bananas should be buy to end the day with 40 bananas",
               A: '80',
               B: '100',
               C: '20',
               D: '40'
           ...
           {
               name:"A spare parts company places a purchase of 100 units of filters to its supplier on 1st of July. It will reach the company in 2 months. If opening stock on 1st July is 500 and monthly sales in 120 units, what is the inventory on 30th of September?",
               A: '360',
               B: '240',
               C: '100',
               D: '260'
           ...
           {
               name:"You need to maintain 2 months of cover at end of April. If opening inventory on April 1st is 500 units and daily sales is 10 units, what shpuld be the purchase receipt?",
               A: '600',
               B: '500',
               C: '400',
               D: 'None of the above'
           ...
           {
               name:"You are a store who hold 10 bottles of a cool drink brand. If daily sales is 5 units and you cannot buy cool drinks for 3 days. What is your sales loss if one bottle of coke is sold at 8 Rs?",
               A: '40',
               B: '120',
               C: '0',
               D: '10'
