...
<body class="theme-red">
    ...
    <div class="scroll-to-top-div visible-lg visible-sm visible-md">
        <button type="button" class="btn btn-primary btn-circle-lg waves-effect waves-circle waves-float waves-light" style="text-align: center;">
    ...
    <section class="content-main">
        <div class="container-fluid">
            <div class="row clearfix" style="margin-left: 0;margin-right: 0;">
                ...
                <div class="col-lg-4 col-md-5 col-sm-4 visible-lg visible-md visible-sm">
                    <h4 class="sub-header">@yield('PAGE_HEADER')</h4>
                </div>
                <div class="col-lg-1 col-md-1 col-sm-1 visible-lg visible-md visible-sm PAGE_UPLOAD">
                    @yield('PAGE_UPLOAD')
                </div>
                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-2 PAGE_DOWNLOAD">
                    @yield('PAGE_DOWNLOAD')
                </div>
                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-2 PAGE_FILTER">
                    @yield('PAGE_FILTER')
                </div>
                <div class="col-xs-12 visible-xs text-center">
                    <h4 class="sub-header" style="display: none;">@yield('PAGE_HEADER')</h4>
                </div>
            </div>
