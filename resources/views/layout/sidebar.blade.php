...
<!------ Include the above in your HEAD tag ---------->
  ...
  <script src="https://use.fontawesome.com/07b0ce5d10.js"></script>
    ...
    <?php if(Session::get('email') == 'vimal@mieone.com' || Session::get('email') == 'bhargavi@headrun.com' || Session::get('email') == 'testuser@gmail.com' || Session::get('email') == 'abi_monish_v' || Session::get('email') == 'tharun_v'){?>
