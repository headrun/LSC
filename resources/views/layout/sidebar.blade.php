...
<!------ Include the above in your HEAD tag ---------->
  ...
  <script src="https://use.fontawesome.com/07b0ce5d10.js"></script>
    ...
    <div class="page-topbar">
        ...
        <div style="color: white;font-size: 20px;font-family: monospace;padding-top:5px;">{{ Session::get('school_name') }}</div>
    ...
    <div class="page-sidebar expandit">
      <div class="sidebar-inner" id="main-menu-wrapper">
          ...
          <!-- <li><a href="/Subjects"><span class="sidebar-icon"><img src="https://image.flaticon.com/icons/svg/1035/1035688.svg" width="25" height="25"></span> <span class="menu-title">Dashboard</span></a></li> -->
          <!-- <li><a href="/Subjects"><span class="sidebar-icon"><img src="https://image.flaticon.com/icons/svg/149/149042.svg" width="25" height="25"></span> <span class="menu-title">Home</span></a></li> -->
          <li id="learn"><a href="/SidebarLearningPage"><span class="sidebar-icon"><img src="https://image.flaticon.com/icons/svg/1454/1454500.svg" width="25" height="25"></span> <span class="menu-title">Learn</span></a></li>
          <li id="practice"><a href="/SidebarPracticePage"><span class="sidebar-icon"><img src="https://image.flaticon.com/icons/svg/744/744422.svg" width="25" height="25"></span> <span class="menu-title">Practice</span></a></li>
	  <li id="test"><a href="/SidebarTestPage"><span class="sidebar-icon"><img src="https://image.flaticon.com/icons/svg/1651/1651685.svg" width="25" height="25"></span> <span class="menu-title">Test</span></a></li>
    ...
    <?php if(Session::get('roll_number') == 'LSC19KV08' || Session::get('roll_number') == 'LSC19KV29' || Session::get('roll_number') == 'LSC19KV48' || Session::get('roll_number') == 'LSC19KV55' || Session::get('roll_number') == 'LSC19KV10' || Session::get('roll_number') == 'LSC19KV12'){?>
    ...
    <?php if(Session::get('email') == 'teacher@gmail.com'){?>
        <li id="rslt"><a href="/SidebarResultPage"><span class="sidebar-icon"><img src="https://image.flaticon.com/icons/svg/1444/1444352.svg" width="25" height="25"></span> <span class="menu-title">Student Result</span></a></li>
    <?php }?>
