...
<!------ Include the above in your HEAD tag ---------->
  ...
  <script src="https://use.fontawesome.com/07b0ce5d10.js"></script>
    ...
    <?php if(Session::get('roll_number') == 'LSC19KV08' || Session::get('roll_number') == 'LSC19KV29' || Session::get('roll_number') == 'LSC19KV48' || Session::get('roll_number') == 'LSC19KV55' || Session::get('roll_number') == 'LSC19KV10'){?>
