  ...
  <div id="login" class="login">
    ...
    <div class="login-form">
      <div class="username-row">
        <input type="text" name = "username" class="username-input" placeholder="Username" style="color: white; " ></input>
      </div>
      <div class="password-row">
        <input type="password" name="password" class="password-input" class="input" placeholder="Password" style="color: white; " ></input>
      </div>
    </div>
    <div class="call-to-action">
      <button class="btn"  style="cursor:pointer;">LETS GO!</button>        
    </div>
    </form>
    @if($errors->any())
    	<div class="message" style="margin-left: 52px;font-size: 15px;font-family: serif;color: blanchedalmond;">{{$errors->first()}}</div>
    @endif
  </div>
</div>
</body>
...
$(document).on('click', '#signin', function(){
 ...
 //   });
  //  } else {
//	$('.message') .html('Please provide details');   	
	//  } 
