...
.jquery-modal{z-index: 11111;}
  ...
  <div class="container">
   ...
   <div class="row" style="margin-left: 7%">
     <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 " style="color: white;">
       <div id="question-one" class="quiz-ans-container" style="padding-bottom: 63px;padding-left: 0px;margin-right: 0px;">
       <h2 style="text-align: -webkit-left;">
        <span style="margin-left: -44px;">Q1.</span>
        <span style="font-family: 'Lora', serif;">Onion sells at 20 Rs/ Kg in a nearby market. You have to spend 50 Rs on auto to go there. If you buy 6 Kg of Onion, how much is you total expenditure?</span></h2>
     </div>
   </div>
     <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 " >
       <img src="{{asset('assets/img/CoseSample.jpg')}}" width="230px" height="200px" alt="Image" style="margin-left: 0px;margin-top: 4%;">
     </div>
 </div>
   <div class="row" style="margin-left: 8%;">
     <div class="col-md-12 col-sm-12" style="color: white;">
       <div class="quiz-choice wrong-q1">
       <p style="text-align:center"> 70 Rs</p>
       </div>
       <div class="quiz-choice correct-q1">
       <p style="text-align:center"> 170 Rs</p>
       </div>
       <div class="quiz-choice wrong-q1">
       <p style="text-align:center"> 120 Rs</p>
       </div>
       <div class="quiz-choice wrong-q1" style="margin-right: 20px;">
       <p style="text-align:center"> 50 Rs</p>
       </div>
     </div>
   </div>
  ...
  <div id="ex1" class="modal">
    ...
    <h3>Onion Price = 20 Rs / Kg</h3>
    <h3 id="step">Step-2</h3>
    <h3>Amount Spent to reach market on auto = 50 Rs</h3>
    <h3 id="step">Step-3</h3>
    <h3>Total 6 Kg of Onions bought</h3>
    <h3 id="step">Step-4</h3>
    <h3>Total Cost for 6 Kg of Onions = 6 Kg * 20 Rs  i.e, 120 Rs</h3>
    <h3 id="step">Step-5</h3>
    <h3>Total Expenditure = Total cost of Onions + Auto charge</h3><br>
    <h3>Total Expenditure = 120 Rs + 50 Rs  i.e, 170 Rs</h3>
    <br>
    <hr> 
