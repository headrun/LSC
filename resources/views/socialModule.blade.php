...
<div class="row" style="width: 100%">
     <div class = "col-lg-9 col-md-9 col-sm-9 col-xs-9" id="cont" style="width: 900px;height: 650px;" ></div>
    <div class = "col-lg-3 col-md-3 col-sm-3 col-xs-3" style="">
        ...
        <br>
        <br>
        <p>Select From and To Ports for Distance</p>
        <label>From :</label><br>
