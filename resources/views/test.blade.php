...
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="Unit2Activity1/css/bootstrap.min.css">
      <link rel="stylesheet" href="Unit2Activity1/css/fontawesome.css">
      <link rel="stylesheet" href="Unit2Activity1/fontawsome/css/all.css">
      <link rel="stylesheet" href="Unit2Activity1/css/style.css">
      <link rel="stylesheet" href="Unit2Activity1/css/introjs.css">
      <link rel="stylesheet" href="Unit2Activity1/fonts.css">
   ...
   <body class="newbg">
     ...
     <div class="content-section">
      ...
      <div class="game-content">
        ...
        <div class="drag-left">
        <div class="plain-section" onclick="location.href = 'Unit2Activity1/plain.html';">
          <img src="Unit2Activity1/images/giphy.gif" alt="plain Journey" />
        ...
        <div class="bus-section" onclick="location.href = 'Unit2Activity1/bus.html';">
          <img src="Unit2Activity1/images/bus-animation.gif" alt="Bus Journey" />
          <div class="plaindetailes">
        ...
        <div class="plain-section" onclick="location.href = 'Unit2Activity1/twowheeler.html';">
          <img src="Unit2Activity1/images/giphy1.gif" alt="Two Wheeler Journey" />
          <div class="plaindetailes">
        ...
        <div class="person">
          <img src="Unit2Activity1/images/cartton-img.png" alt="" />
        </div>
   ...
   <script src="Unit2Activity1/js/jquery.min.js" type="text/javascript"></script>
   <script src="Unit2Activity1/js/popper.min.js" type="text/javascript"></script>
   <script src="Unit2Activity1/js/bootstrap.min.js" type="text/javascript"></script>
   <script src="Unit2Activity1/js/intro.js" type="text/javascript"></script>
