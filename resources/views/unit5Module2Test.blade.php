...
<body>
    <div class="container">
        <div class="card">
                <span style="font-size: 28px;line-height: 28px;color: #7d929d;">Storage System and MHE</span>
                <hr>
...
<script>
    ...
    function Decrement() {
        if (document.getElementById) {
            ...
            if (mins < 0) {
                window.location = "{{url()}}/submitQuiz/?subject=Unit5&module=Storage System and MHE";
                alert('time up');
                minutes.value = 0;
                seconds.value = 0;
            }
...
<script>
 ...
 var nextHide;
   var AllQuestions = {
           ...
           {
               name:"Which of the following cannot hold a pallet?",
               A: 'Shelving System',
               B: 'Racking System',
               C: 'Ground',
               D: 'None of the above'
           ...
           {
               name:"What is the process of physically counting the stock periodically to check whether it is equal to the stock maintained in the system?",
           ...
           {
               name:"Apparel is received into a warehouse in Boxes. Each box can hold 20 clothing units. If toally 4000 units are received, how many pallets are required to hold the material if one pallet can store 10 boxes?",
               A: '30',
               B: '40',
               C: '20',
               D: '200'
           ...
           {
               name:"A packer in a warehouse can pick 80 pieces of apparel in 1 hour. 10 packers work in 1 shift of 8 hours. What is the number of pieces that can be picked?",
               A: '6400',
               B: '640',
               C: '800',
               D: 'None of the above'
           ...
           {
               name:"There are 2 pickers in a warehouse. One picks boxes and other picks pallets. Box picker can pick 200 boxes in 1 hour and pallet pciker can pick 15 pallets in 1 hour. Ox picker is asked to pick 500 boxes and pallet picker is asked to pick 45 pallets. Who picks faster?",
               A: '6400',
               B: '640',
               C: '800',
               D: 'None of the above'
           ...
           {
               name:"True or False: Reach truck is used for box picking",
               A: 'TRUE',
               B: 'FALSE',
               C: '',
               D: ''
