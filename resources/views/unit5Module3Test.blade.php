...
<body>
    <div class="container">
        <div class="card">
                <span style="font-size: 28px;line-height: 28px;color: #7d929d;">Picking Strategies</span>
                <hr>
...
<script>
    ...
    function Decrement() {
        if (document.getElementById) {
            ...
            if (mins < 0) {
                window.location = "{{url()}}/submitQuiz/?subject=Unit5&module=Picking Strategies";
                alert('time up');
                minutes.value = 0;
                seconds.value = 0;
            }
...
<script>
 ...
 var nextHide;
   var AllQuestions = {
           data: [
           {
               name:'Which of the following is not a picking method?',
               A: 'Batch Picking',
               B: 'Order Picking',
               C: 'Multi order Picking',
               D: 'None of the above'
           },
           {
               name:"The process of combining all orders to pcik at product level rather than order level is called?",
               A: 'Batch picking',
               B: 'Order Picking',
               C: 'Multi order Picking',
               D: 'None of theabove'
           ...
           {
               name:"Online ecommerce industry generally follows which picking method?",
               A: 'Batch picking',
               B: 'Order Picking',
               C: 'Multi order Picking',
               D: 'None of the above'
